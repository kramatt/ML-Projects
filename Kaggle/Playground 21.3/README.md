...
**Objective:** Predict a real, continuous target value for each ID using 19 categorical and 11 continuous features.
...
On the competition set, this model earned a score of **x.xx**.

The highest current score is x.xx, and a perfect score would be 1.
